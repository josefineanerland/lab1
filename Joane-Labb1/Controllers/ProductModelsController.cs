...
namespace Joane_Labb1.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,Description,Price,ImageUrl")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ProductName,Description,Price,ImageUrl")] ProductModel productModel)
        {
